...
type fnCreateRootWindowCallback func()
type fnCreateWindowCallback func(string)
...
var (
	...
	OnContextInitialized func()
	OnBrowserCreated     func(handle unsafe.Pointer, browser *Browser)
)
...
func init() {
	...
	// Functions
	setWindowText, _ = syscall.GetProcAddress(libuser32, "SetWindowTextW")
}
...
func SetWindowText(hWnd unsafe.Pointer, text string) bool {
